...
function itrobes_enqueue_assets() {
    ...
    wp_enqueue_style('itrobes-style', get_stylesheet_uri(), array('swiper'), '1.5');
    wp_enqueue_script('itrobes-main', get_template_directory_uri() . '/assets/js/main.js', array('swiper'), '1.5', true);
}
